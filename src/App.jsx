          ...
          <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col text-gray-900 dark:text-gray-100 transition-colors">
            ...
            <main className="flex-grow container mx-auto px-4 py-8">
              <Routes>
                ...
                <Route path="/admin/events/analytics" element={
                  <AdminRoute>
                    <EventAnalytics />
                  </AdminRoute>
                } />
                ...
                <Route path="/admin/events/:eventId/volunteers" element={
                  <AdminRoute>
                ...
                <Route path="/volunteer/forms/:eventId" element={
                  <VolunteerRoute>
                    <FormBuilder />
                  </VolunteerRoute>
                } />
                <Route path="/volunteer/events/:eventId/registrations" element={
                  <VolunteerRoute>
                    <EventRegistrations />
                  </VolunteerRoute>
                } />
