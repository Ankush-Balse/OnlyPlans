    ...
    const handleAssignVolunteers = async () => {
        try {
            ...
            for (const volunteerId of volunteersToRemove) {
                await axios.delete(`/api/events/${eventId}/volunteers/${volunteerId}`);
            }
            ...
            for (const volunteerId of volunteersToAdd) {
                await axios.post(`/api/events/${eventId}/volunteers`, {
                    volunteerId
                });
            }
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                            {filteredVolunteers.map((volunteer) => (
                                <tr key={volunteer._id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                                            ...
                                            {selectedVolunteers.includes(volunteer._id) ? "Assigned" : "Not Assigned"}
                                        </span>
                                    </td>
